...
def make_sidebar():
    with st.sidebar:
        ...
        if st.session_state.get("logged_in", False):
            st.page_link("pages/page1.py", label="How can i help you", icon="🔒")
            st.page_link("pages/page2.py", label="EMAIL EXTRACTOR", icon="🕵️")
            st.page_link("pages/page3.py", label="HEALTH AND RECOMENDATION", icon="🧬")
